...
//Step 4: 執行 SQL 指令, 若要操作記錄集, 需使用executeQuery, 才能傳回ResultSet	
		   ...
		   ResultSet rs=stmt.executeQuery(sql);
		   out.print("<form id=\"order_type\" method=\"post\" action=\"type.jsp\" align=\"center\"> <select  style=\"font-size:25px\" name=\"store\" id=\"type_select\" form=\"order_type\" onchange=\"this.form.submit()\"><OPTION  SELECTED>選擇店家</option> ");
//  逐筆顯示, 直到沒有資料(最多還是5筆)
           while(rs.next())
                {	
