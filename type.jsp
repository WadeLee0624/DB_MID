...
//Step 3: 選擇資料庫   
		   ...
		   out.print("<form id=\"order_type\" method=\"post\" action=\"order.jsp\" align=\"center\"> <select style=\"font-size:25px\" name=\"otype\" id=\"type_select\" form=\"order_type\" onchange=\"this.form.submit()\"><OPTION  SELECTED>選擇類型</option>");
//  逐筆顯示, 直到沒有資料(最多還是5筆)
           while(rs.next())
                {				
