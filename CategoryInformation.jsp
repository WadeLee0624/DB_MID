...
<tr>
<td bgcolor="#FFFFFF" width ="15%">種類編號</td><td bgcolor="#FFFFFF" width ="15%">種類名稱</td>
</tr>
<%while(rs.next()){
	String CID = rs.getString("CID");
	String C_NAME = rs.getString("C_NAME");%>
<tr>
<td bgcolor="#FFFFFF"><%=CID%></td><td bgcolor="#FFFFFF"><%=C_NAME%></td>
</tr>
<%} %>
<a href="MenuInformation.jsp">返回價目表</a>
</p>
<br>
<%		
//Step 5: 關閉連線
