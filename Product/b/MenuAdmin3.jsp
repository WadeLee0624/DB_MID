...
//Step 2: 建立連線 	
        ...
        if(conn.isClosed())
           out.println("連線建立失敗");
             ...
             sql="select * from (select ROWNUM ROW_NUM, P.* from (select PRODUCT.PID,PRODUCT.CID,PRODUCT.P_NAME,PRODUCT.UNIT_PRICE,PRODUCT.P_DESC from PRODUCT ORDER BY PRODUCT.PID ASC) P where ROWNUM < 31) WHERE ROW_NUM > 20";
